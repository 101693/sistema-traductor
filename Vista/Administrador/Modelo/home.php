<?php namespace Modelo;
	class home{
		...
		public function Buscador(){
			$sql = "SELECT * FROM verbo WHERE verbo LIKE '%{$this->verbo}%'";//seleccioname toda la tabla verbo donde la columna verbo tenga los mismos caracteres que este verbo
			//like '% $ %' significa 0 o mas caracteres, develve todas la permutaciones consideradas
